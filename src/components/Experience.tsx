  ...
  const projectImages = [
    {
      ...
      images: [
        { src: '/imgs/Screenshot 2025-06-24 111103.png', title: 'Main Dashboard', description: 'Overview of total vendors, items, and purchase orders with statistics' }
      ]
    },
    {
      category: 'Vendor Management',
      images: [
        { src: '/imgs/Screenshot 2025-06-24 111121.png', title: 'Vendors List', description: 'Complete vendor management with contact information and actions' },
        { src: '/imgs/Screenshot 2025-06-24 111245.png', title: 'Register New Vendor', description: 'Form to add new vendors with contact details' },
        { src: '/imgs/Screenshot 2025-06-24 111143.png', title: 'Vendor Actions', description: 'Edit, view, and delete vendor options' }
      ]
    },
    {
      category: 'Item Management', 
      images: [
        { src: '/imgs/Screenshot 2025-06-24 111133.png', title: 'Items List', description: 'Product catalog with descriptions and pagination' },
        { src: '/imgs/Screenshot 2025-06-24 111229.png', title: 'Create New Item', description: 'Form to add new items to the inventory' }
      ]
    },
    {
      category: 'Purchase Orders',
      images: [
        { src: '/imgs/Screenshot 2025-06-24 111152.png', title: 'Purchase Orders List', description: 'Track all purchase orders with vendor details and amounts' },
        { src: '/imgs/Screenshot 2025-06-24 111219.png', title: 'New Purchase Order', description: 'Create new purchase orders with item selection' }
      ]
    },
    {
      category: 'System Settings',
      images: [
        { src: '/imgs/Screenshot 2025-06-24 111205.png', title: 'System Configuration', description: 'System information and logo management settings' }
      ]
    }
  ];
